...
1. Confirmar en producción el login de `assessment-dashboard.html` (Edge Function nueva, no se pudo probar de punta a punta desde esta sesión — ver 5, 14/08/2026).
